...
import androidx.compose.foundation.text.KeyboardOptions
import androidx.compose.material3.*
// ✅ Imports cần thiết cho StateFlow
...
fun VerifyOtpScreen( navController: NavController,
    ...
    // Sử dụng collectAsStateWithLifecycle để theo dõi StateFlow an toàn hơn
    ...
    // 2. Xử lý điều hướng sau khi lưu thông tin thành công (nếu có logic ở đây)
...
// -------------------- HỖ TRỢ GIAO DIỆN -------------------- //
// (Giữ nguyên các hàm OTPInputField, BoxDecor và VienChamCham)
